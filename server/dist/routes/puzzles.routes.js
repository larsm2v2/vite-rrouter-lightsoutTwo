  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (difficulty === "custom") {
      ...
      try {
        ...
        const saved =
          ((_a = rows[0]) === null || _a === void 0 ? void 0 : _a.saved_maps) ||
          [];
        const result = {};
        ...
        return res
          .status(500)
          .json({ error: "Failed to fetch custom puzzles" });
      }
    }
    ...
    if (
      difficultyParam !== "" &&
      !validDifficulties.includes(difficultyParam)
    ) {
      return res
        .status(404)
...
router.post("/validate", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const workerPath = path_1.default.resolve(
        __dirname,
        "../utils/solverWorker.js"
      );
...
router.post("/create", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const { rows: levelRows } = yield database_1.default.query(
      ...
      const nextLevel = (
        (_a = levelRows[0]) === null || _a === void 0 ? void 0 : _a.max_level
      )
      ...
      const { rows: statsRows } = yield database_1.default.query(
        `SELECT saved_maps FROM game_stats WHERE user_id = $1`,
        [req.user.id]
      );
      const updatedSavedMaps =
        ((_b = statsRows[0]) === null || _b === void 0
          ? void 0
          : _b.saved_maps) || [];
      res.status(201).json({
        success: true,
