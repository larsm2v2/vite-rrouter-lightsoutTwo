...
const passport_1 = __importStar(require("./config/auth/passport"));
...
const safariHelmetConfig = (0, helmet_1.default)({
...
const standardHelmetConfig = (0, helmet_1.default)();
// Apply the appropriate Helmet config based on browser detection
app.use((req, res, next) => {
    const userAgent = req.headers["user-agent"] || "";
    const isSafari = typeof userAgent === "string" &&
        userAgent.includes("Safari") &&
        !userAgent.includes("Chrome");
    console.log(`Browser detection: ${isSafari ? "Safari" : "Non-Safari"} browser`);
    if (isSafari) {
...
const allowedOrigins = [
    (_a = process.env.CLIENT_URL) === null || _a === void 0 ? void 0 : _a.replace(/\/$/, ""),
...
app.use((req, res, next) => {
    ...
    try {
        ...
        if (req.method === "OPTIONS") {
            ...
            res.setHeader("Access-Control-Allow-Headers", "Content-Type,Authorization,X-Requested-With,Accept,Set-Cookie");
...
apiRouter.use((req, _res, next) => {
    ...
    console.log("sessionID:", req.sessionID, "req.user:", req.user);
    next();
});
// Mount auth routes
apiRouter.use("/auth", auth_routes_1.default);
// Mount puzzle routes
apiRouter.use("/puzzles", puzzles_routes_1.default);
                ...
                layer.handle.stack.forEach((l) => {
                    ...
                    if (l.route && l.route.path) {
                        const methods = Object.keys(l.route.methods)
                            .map((m) => m.toUpperCase())
                            .join(",");
                        routes.push(`${methods} /api${((_a = layer.regexp) === null || _a === void 0 ? void 0 : _a.toString()) || ""}${l.route.path}`);
                    }
                });
            }
        });
...
// Protected routes
apiRouter.get("/profile", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
apiRouter.get("/stats/:userId", (0, express_validator_1.param)("userId").isInt().toInt(), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.user)
        return res.status(401).json({ error: "Unauthorized" });
    try {
...
apiRouter.post("/game/progress", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.user)
        return res.status(401).json({ error: "Unauthorized" });
    try {
...
app.get("/test/cookie", (req, res) => {
    ...
    res.json({
        ...
        isSafari: ((_a = req.headers["user-agent"]) === null || _a === void 0 ? void 0 : _a.includes("Safari")) &&
            !((_b = req.headers["user-agent"]) === null || _b === void 0 ? void 0 : _b.includes("Chrome")),
    });
});
...
function startServer() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        ensureDatabaseInitialized()
            ...
            .catch((err) => console.error("Database initialization error (non-fatal at startup):", err));
    });
}
if (process.env.NODE_ENV !== "test") {
