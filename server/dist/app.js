...
app.get("/profile", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      // Get user profile
      const userResult = yield database_1.default.query(
        `SELECT id, email, display_name, avatar 
       FROM users WHERE id = $1`,
        [req.user.id]
      );
      // Get game stats
      const statsResult = yield database_1.default.query(
      ...
      const { rows: minMovesRows } = yield database_1.default.query(
      ...
      res.json({
        ...
        stats: Object.assign(Object.assign({}, baseStats), {
...
app.get(
  "/stats/:userId",
  (0, express_validator_1.param)("userId").isInt().toInt(),
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      if (!req.user) return res.status(401).json({ error: "Unauthorized" });
      try {
        const stats = yield database_1.default.query(
          `SELECT 
...
app.post("/game/progress", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!req.user) return res.status(401).json({ error: "Unauthorized" });
    try {
      ...
      const userStatsResult = yield database_1.default.query(
      ...
      const currentLevel =
        (userStats === null || userStats === void 0
          ? void 0
...
const authRateLimiter = (0, express_rate_limit_1.default)({
  ...
  skip: (req) => {
    ...
    return (
      req.path === "/auth/check" &&
      req.method === "GET" &&
      !!((_a = req.get("Referer")) === null || _a === void 0
        ? void 0
        : _a.includes("/login"))
    );
  },
